...
C:/Users/bluehope/AppData/Local/Julia-1.2.0/bin/julia.exe -p 4 src/Jx_col_spin_exchange.jl  -T examples/NiO_G-AFM_U0.OpenMx/nio_J_openmx.toml
# J(q) -> J(R)
...
sleep 2
C:/Users/bluehope/AppData/Local/Julia-1.2.0/bin/julia.exe src/Jx_postprocess.jl --cellvectors  2_2_2 --baseatom1 1 --atom2 1,2 --orbital_name all_all  examples/NiO_G-AFM_U0.OpenMx/jx.col.spin_0.0
